...
client.on("ready", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                bot = index_js_1.default;
                bot.setChannels(client.channels);
                twitchWebHookHandler = new index_js_2.default(config_js_1.config.TWITCH_CLIENT_ID, config_js_1.config.TWITCH_SECRET, config_js_1.config.TWITCH_USER_ID, '88f04167acb2.ngrok.io', 3000);
                return [4 /*yield*/, twitchWebHookHandler.listenWebhooks(function () {
                        bot.sendMessageToChannel(config_js_1.config.BOT_CHANNEL_NAME, 'Striimi käynnissä! https://www.twitch.tv/teamaquafi');
                    })];
            case 1:
                _a.sent();
